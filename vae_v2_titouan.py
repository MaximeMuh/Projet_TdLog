...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Conv2d(3,32,4,2)
#        self.fc2 = nn.Conv2d(32,64,4,2)
        self.fc21 = nn.Linear(int(((128-4)/2+1)**2),196) # mean
        self.fc22 = nn.Linear(int(((128-4)/2+1)**2),196) # variance
        self.fc3 = nn.Linear(196, int(((128-4)/2+1)**2))
        self.fc4 = nn.ConvTranspose2d(32, 3, 4, 2)
...
#        h3 = F.relu(self.fc3(z))
    ...
    def forward(self, x):
        ...
        z = F.relu(self.fc3(z))
        z = z.view(z.size(0),z.size(1),int((128-4)/2+1),int((128-4)/2+1))
